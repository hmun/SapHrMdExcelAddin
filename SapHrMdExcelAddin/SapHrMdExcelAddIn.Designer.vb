...
Partial Public NotInheritable Class SapHrMdExcelAddIn
...
Partial Friend NotInheritable Class Globals
    ...
    Private Shared _SapHrMdExcelAddIn As SapHrMdExcelAddIn
    ...
    Friend Shared Property SapHrMdExcelAddIn() As SapHrMdExcelAddIn
        Get
            Return _SapHrMdExcelAddIn
        End Get
        Set
            If (_SapHrMdExcelAddIn Is Nothing) Then
                _SapHrMdExcelAddIn = value
            Else
